...
function describeUserUsingInOperator(u) {
    if ("permission" in u) {
...
const unionOfArrays = Math.random() > 0.5 ? ["a", "b", "c"] : [1, 2, 3, 4, 5]; //here its either be the array of string or either be the array of numbers
